    ...
    <div class="max-w-full mx-auto">
        ...
        <form action="{{ route('admin.section-items.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                ...
                {{-- DESCRIPTION --}}
                <textarea id="description_en" name="description_en" class="w-full border  text-black px-2 rounded-xl">
    {{ old('description_en') }}
</textarea>
            ...
            <div>
                ...
                <textarea name="meta" class="w-full border bg-gray-800 text-gray-400 p-2 rounded-xl" placeholder='{"key":"value"}'></textarea>
            </div>
