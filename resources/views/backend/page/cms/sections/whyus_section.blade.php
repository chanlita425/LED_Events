...
@section('page-title', 'Why Us Section')
@section('page-subtitle', 'Manage why us page sections')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col-2 justify-between ">
        ...
        <div>
            ...
            <p class="text-sm text-gray-400 mt-1">
                Manage advantages / features / reasons
            </p>
        </div>
    ...
    <div class="flex flex-wrap gap-2">
        ...
        <a href="{{ route('admin.sections.whyus_section') }}"
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <thead class="bg-white/5">
                            <tr>
                                <th class="px-6 py-4 text-left text-gray-400">Feature</th>
                                <th class="px-6 py-4 text-left text-gray-400">Icon</th>
                                ...
                                <tr class="border-t border-white/5 hover:bg-white/[0.02]">
                                    ...
                                    <td class="px-6 py-5">
                                        @if($item->icon || $item->image)
                                            <img src="{{ asset('storage/' . ($item->icon ?? $item->image)) }}"
