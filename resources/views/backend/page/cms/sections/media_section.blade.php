...
@section('page-title', 'Media Section')
@section('page-subtitle', 'Manage media content blocks')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col-2 justify-between ">
        ...
        <div>
            ...
            <p class="text-sm text-gray-400 mt-1">
                Manage media (gallery, videos, press)
            </p>
        </div>
    ...
    <div class="flex flex-wrap gap-2">
        ...
        <a href="{{ route('admin.sections.media_section') }}"
                ...
                <div class="overflow-x-auto">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <thead class="bg-white/5">
                            <tr>
                                <th class="px-6 py-4 text-left text-gray-400">Media</th>
